...
with col1:
    ...
    origins_input = st.text_area("Insira um endereço por linha (Ex. R. Paschoal Marmo, 1888 - Jardim Nova Italia, Limeira - SP, 13484-332)", key="origens_input")

with col2:
    st.subheader("Endereços de Destino")
    destinations_input = st.text_area("Insira um endereço por linha (Ex. R. Paschoal Marmo, 1888 - Jardim Nova Italia, Limeira - SP, 13484-332)", key="destinos_input")
